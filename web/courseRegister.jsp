    ...
    <body bgcolor= "#F5F1DE">
       ...
       <%            
            try {
                ...
                String message = "";
                message=sManager.registerCourse(cid, Integer.parseInt(session.getAttribute("corgi").toString()));
                if (message.equals("")){
                   %>
                   <div class="container">
                   <div class="large-12 centered columns">
                     <form action="homepage.jsp" method="POST">
                         <input type="submit" value="Course Registered Successfully" class="button expand"/>
                     </form>
                   </div>
                   </div>
