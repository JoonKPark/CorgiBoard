    ...
    <body bgcolor= "#F5F1DE">
        ...
        <div class="row">
            <div class="radius panel large-5 columns large-centered">			
                <form action="deleteassignmentresult.jsp" method="POST">
                    <div class="row">
                        <div class="large-12 columns">
                            Assignment ID: <input name="aid" placeholder="Assignment ID" type="number" maxlength="11" required/>
                        </div>
                    </div>
                    
                    <input type="submit" value="delete assignment" class="button expand"/>
                </form> 
            </div>
        </div>
